# 1. exibir_cardapio():** Esta função deve criar o dicionário do cardápio 
# e usar um loop `for` para imprimi-lo na tela.
...
def receber_pedido(cardapio):
    ...
    while True:
        ...
        if sabor == "sair":
            ...
            print("Esse sabor não está disponível. Escolha outro.")
    return pedido
